...
$(document).keyup(function(event){
		if (cheater !== true){
			...
			if (playerVal == arr[x]){
				...
				switch (playerVal){
					case 1:
						opt1.html('<img src="imgs/sturwurs/Ani_Obi-left.gif"></img>');
						cheater = true;
						setTimeout(function(){
							opt1.html('<img src="imgs/sturwurs/Ani_Obi.gif"></img>');
							cheater = false;
						},2000);
					break;
					case 3:
						opt1.html('<img src="imgs/sturwurs/Ani_Obi-right.gif"></img>');
						cheater = true;
						setTimeout(function(){
							opt1.html('<img src="imgs/sturwurs/Ani_Obi.gif"></img>');
							cheater = false;
					...
					break;
					case 2:
						opt1.html('<img src="imgs/sturwurs/Ani_Obi-down.gif"></img>');
						cheater = true;
						setTimeout(function(){
							opt1.html('<img src="imgs/sturwurs/Ani_Obi.gif"></img>');
							cheater = false;
					...
					break;
					case 0:
						opt1.html('<img src="imgs/sturwurs/Ani_Obi-up.gif"></img>');
						cheater = true;
						setTimeout(function(){
							opt1.html('<img src="imgs/sturwurs/Ani_Obi.gif"></img>');
							cheater = false;
